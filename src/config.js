...
export function loadConfig() {
  ...
  return {
    ...
    requestDelayMs: clampNumber(raw.requestDelayMs, 0, 10000, 1200),
    brandDelayMs: clampNumber(raw.brandDelayMs, 0, 30000, 4000),
    brandRetryCount: clampNumber(raw.brandRetryCount, 1, 4, 2),
    brandRetryDelayMs: clampNumber(raw.brandRetryDelayMs, 1000, 60000, 10000),
    detailChecksPerRun: clampNumber(raw.detailChecksPerRun, 0, 100, 8),
